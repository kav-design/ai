...
const testimonials = [
  {
    quote:
      "We were missing 30% of our calls. Now Milo catches every one and books them before we even know they called. Bookings up 40% this quarter.",
    name: "Dr. Emily Chen",
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div ref={gridRef} className="grid gap-6 md:grid-cols-3">
          {testimonials.map((t, i) => (
            ...
            >
              <TiltCard className="h-full rounded-2xl border border-border bg-white p-8 shadow-sm">
                {/* Quote mark */}
                <div className="mb-4 text-4xl leading-none text-border">
                  &ldquo;
                </div>
